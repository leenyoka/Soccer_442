 ...
 */
public class activity_live_commentry extends ActionBarActivity {
   ...
   public boolean ShowError()
    ...
    private void Initialize() {
        ...
        dialog = new ProgressDialog(activity_live_commentry.this);
        ...
        final Thread eThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final Live comments; Live holder = null;
                ...
                try {
                    ...
                    statsHolder = superSport.GetStats(String.valueOf(liveGame.MatchId));
                    lineupsHolder = new SuperSport().GetLineUp(String.valueOf(liveGame.MatchId));
                }
                catch (Exception ex)
                {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            if (comments != null) {
                                ...
                                title.setText(comments.MatchStatus);
                               ...
                               //     scorers.getLayoutParams().height = 50;
                                //} else scorers.getLayoutParams().height = 100;
                            }
                            SetStats(stats);
                            SetLineUp(lineups);
                            dialog.hide();
